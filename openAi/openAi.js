...
async function storyBeginningCreation(
  ...
  const messages = [
    {
      role: 'system',
      content: `Tu es mon assistant game-master qui connaît sur le bout des doigts l'univers de donjon et dragon. Tu devras créer l'histoire du jeu de rôles en fonction des informations que je vais te fournir, cette histoire contiendra ${storyLength} phases de jeu et se déroulera dans plutôt en ${style}. Chacune de ces phases contiendra un résumé de l'histoire en cours, posant le contexte pour les joueurs, et 3 choix que tu proposera à chaque joueur en fonction de leurs caractéristiques et de leur avancée dans le jeu.`,
    },
    {
      role: 'user',
      content: `Crée le début de l'histoire dans l'univers de la ${univers}. Il y a ${charactersDescription.length} joueurs. La description des personnages est : ${charactersDescription}. tu renverras un json avec un title : le titre de l'histoire, un storyBeginning : le début de l'histoire assez détaillé, et des choices : un tableau contenant 3 choix pour chaque joueur. Sois inventif !`,
    },
  ];
...
module.exports = { charactersCreation, storyBeginningCreation, continueStory };
